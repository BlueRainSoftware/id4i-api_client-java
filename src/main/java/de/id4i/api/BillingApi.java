...
public class BillingApi {
     ...
     */
    public com.squareup.okhttp.Call getPositionsForOrganizationCall(Long organizationId, LocalDateTime fromDate, LocalDateTime toDate, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call getPositionsForOrganizationValidateBeforeCall(Long organizationId, LocalDateTime fromDate, LocalDateTime toDate, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     */
    public List<BillingPosition> getPositionsForOrganization(Long organizationId, LocalDateTime fromDate, LocalDateTime toDate) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<BillingPosition>> getPositionsForOrganizationWithHttpInfo(Long organizationId, LocalDateTime fromDate, LocalDateTime toDate) throws ApiException {
     ...
     */
    public com.squareup.okhttp.Call getPositionsForOrganizationAsync(Long organizationId, LocalDateTime fromDate, LocalDateTime toDate, final ApiCallback<List<BillingPosition>> callback) throws ApiException {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getSumForOrganizationCall(Long organizationId, LocalDateTime fromDate, LocalDateTime toDate, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getSumForOrganizationValidateBeforeCall(Long organizationId, LocalDateTime fromDate, LocalDateTime toDate, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ServiceCosts getSumForOrganization(Long organizationId, LocalDateTime fromDate, LocalDateTime toDate) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ServiceCosts> getSumForOrganizationWithHttpInfo(Long organizationId, LocalDateTime fromDate, LocalDateTime toDate) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getSumForOrganizationAsync(Long organizationId, LocalDateTime fromDate, LocalDateTime toDate, final ApiCallback<ServiceCosts> callback) throws ApiException {
