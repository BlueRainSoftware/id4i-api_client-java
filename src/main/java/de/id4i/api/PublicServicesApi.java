...
public class PublicServicesApi {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiError go(String guid) throws ApiException {
        ApiResponse<ApiError> resp = goWithHttpInfo(guid);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ApiError> goWithHttpInfo(String guid) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call goAsync(String guid, final ApiCallback<ApiError> callback) throws ApiException {
