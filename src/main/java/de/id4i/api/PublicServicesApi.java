...
public class PublicServicesApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getRoutesCall(String id4n, String type, Boolean interpolate, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getRoutesValidateBeforeCall(String id4n, String type, Boolean interpolate, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getRoutesCall(id4n, type, interpolate, progressListener, progressRequestListener);
        return call;
    ...
    public List<Route> getRoutes(String id4n, String type, Boolean interpolate) throws ApiException {
        ApiResponse<List<Route>> resp = getRoutesWithHttpInfo(id4n, type, interpolate);
        return resp.getData();
    }
    ...
    public ApiResponse<List<Route>> getRoutesWithHttpInfo(String id4n, String type, Boolean interpolate) throws ApiException {
        com.squareup.okhttp.Call call = getRoutesValidateBeforeCall(id4n, type, interpolate, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getRoutesAsync(String id4n, String type, Boolean interpolate, final ApiCallback<List<Route>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getRoutesValidateBeforeCall(id4n, type, interpolate, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<Route>>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call listPublicHistoryCall(String id4n, Integer offset, Integer limit, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call listPublicHistoryValidateBeforeCall(String id4n, Integer offset, Integer limit, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = listPublicHistoryCall(id4n, offset, limit, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PaginatedHistoryItemResponse listPublicHistory(String id4n, Integer offset, Integer limit) throws ApiException {
        ApiResponse<PaginatedHistoryItemResponse> resp = listPublicHistoryWithHttpInfo(id4n, offset, limit);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PaginatedHistoryItemResponse> listPublicHistoryWithHttpInfo(String id4n, Integer offset, Integer limit) throws ApiException {
        com.squareup.okhttp.Call call = listPublicHistoryValidateBeforeCall(id4n, offset, limit, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call listPublicHistoryAsync(String id4n, Integer offset, Integer limit, final ApiCallback<PaginatedHistoryItemResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = listPublicHistoryValidateBeforeCall(id4n, offset, limit, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PaginatedHistoryItemResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call readOrganizationInfoCall(String organizationId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call readOrganizationInfoValidateBeforeCall(String organizationId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = readOrganizationInfoCall(organizationId, progressListener, progressRequestListener);
        return call;
    ...
    public Organization readOrganizationInfo(String organizationId) throws ApiException {
        ApiResponse<Organization> resp = readOrganizationInfoWithHttpInfo(organizationId);
        return resp.getData();
    }
    ...
    public ApiResponse<Organization> readOrganizationInfoWithHttpInfo(String organizationId) throws ApiException {
        com.squareup.okhttp.Call call = readOrganizationInfoValidateBeforeCall(organizationId, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call readOrganizationInfoAsync(String organizationId, final ApiCallback<Organization> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = readOrganizationInfoValidateBeforeCall(organizationId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Organization>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
