...
public class PublicServicesApi {
    ...
    public PaginatedResponseOfHistoryItem listPublicHistory(String id4n, Integer offset, Integer limit) throws ApiException {
        ApiResponse<PaginatedResponseOfHistoryItem> resp = listPublicHistoryWithHttpInfo(id4n, offset, limit);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call listPublicHistoryAsync(String id4n, Integer offset, Integer limit, final ApiCallback<PaginatedResponseOfHistoryItem> callback) throws ApiException {
