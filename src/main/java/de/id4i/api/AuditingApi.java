...
import de.id4i.api.model.PaginatedResponseOfChangeLogEntry;
...
public class AuditingApi {
     ...
     */
    public PaginatedResponseOfChangeLogEntry listOrganizationChangeLog(String organizationId, String messageMimeType, LocalDateTime fromDate, LocalDateTime toDate, Integer offset, Integer limit) throws ApiException {
        ApiResponse<PaginatedResponseOfChangeLogEntry> resp = listOrganizationChangeLogWithHttpInfo(organizationId, messageMimeType, fromDate, toDate, offset, limit);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PaginatedResponseOfChangeLogEntry> listOrganizationChangeLogWithHttpInfo(String organizationId, String messageMimeType, LocalDateTime fromDate, LocalDateTime toDate, Integer offset, Integer limit) throws ApiException {
     ...
     */
    public com.squareup.okhttp.Call listOrganizationChangeLogAsync(String organizationId, String messageMimeType, LocalDateTime fromDate, LocalDateTime toDate, Integer offset, Integer limit, final ApiCallback<PaginatedResponseOfChangeLogEntry> callback) throws ApiException {
