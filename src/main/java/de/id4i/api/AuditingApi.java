...
public class AuditingApi {
     ...
     * @param organizationId Organization-ID of change log entries to be listed (required)
     ...
     */
    public com.squareup.okhttp.Call listOrganizationChangeLogCall(Long organizationId, String messageMimeType, LocalDateTime fromDate, LocalDateTime toDate, Integer offset, Integer limit, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call listOrganizationChangeLogValidateBeforeCall(Long organizationId, String messageMimeType, LocalDateTime fromDate, LocalDateTime toDate, Integer offset, Integer limit, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     */
    public PaginatedChangeLogEntryResponse listOrganizationChangeLog(Long organizationId, String messageMimeType, LocalDateTime fromDate, LocalDateTime toDate, Integer offset, Integer limit) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PaginatedChangeLogEntryResponse> listOrganizationChangeLogWithHttpInfo(Long organizationId, String messageMimeType, LocalDateTime fromDate, LocalDateTime toDate, Integer offset, Integer limit) throws ApiException {
     ...
     */
    public com.squareup.okhttp.Call listOrganizationChangeLogAsync(Long organizationId, String messageMimeType, LocalDateTime fromDate, LocalDateTime toDate, Integer offset, Integer limit, final ApiCallback<PaginatedChangeLogEntryResponse> callback) throws ApiException {
