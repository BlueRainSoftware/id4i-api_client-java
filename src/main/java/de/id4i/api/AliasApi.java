...
public class AliasApi {
    ...
    public PaginatedResponseOfGuid searchByAlias(String alias, String aliasType, Integer offset, Integer limit) throws ApiException {
        ApiResponse<PaginatedResponseOfGuid> resp = searchByAliasWithHttpInfo(alias, aliasType, offset, limit);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call searchByAliasAsync(String alias, String aliasType, Integer offset, Integer limit, final ApiCallback<PaginatedResponseOfGuid> callback) throws ApiException {
