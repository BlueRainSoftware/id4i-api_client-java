...
public class HistoryApi {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PaginatedResponseOfHistoryItem filteredList(String id4n, Boolean includePrivate, String organization, List<String> type, List<String> qualifier, LocalDateTime fromDate, LocalDateTime toDate, Integer offset, Integer limit) throws ApiException {
        ApiResponse<PaginatedResponseOfHistoryItem> resp = filteredListWithHttpInfo(id4n, includePrivate, organization, type, qualifier, fromDate, toDate, offset, limit);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PaginatedResponseOfHistoryItem> filteredListWithHttpInfo(String id4n, Boolean includePrivate, String organization, List<String> type, List<String> qualifier, LocalDateTime fromDate, LocalDateTime toDate, Integer offset, Integer limit) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call filteredListAsync(String id4n, Boolean includePrivate, String organization, List<String> type, List<String> qualifier, LocalDateTime fromDate, LocalDateTime toDate, Integer offset, Integer limit, final ApiCallback<PaginatedResponseOfHistoryItem> callback) throws ApiException {
    ...
    public PaginatedResponseOfHistoryItem list(String id4n, String organizationId, Boolean includePrivate, Integer offset, Integer limit) throws ApiException {
        ApiResponse<PaginatedResponseOfHistoryItem> resp = listWithHttpInfo(id4n, organizationId, includePrivate, offset, limit);
        return resp.getData();
    }
     ...
     */
    @Deprecated
    public ApiResponse<PaginatedResponseOfHistoryItem> listWithHttpInfo(String id4n, String organizationId, Boolean includePrivate, Integer offset, Integer limit) throws ApiException {
     ...
     */
    @Deprecated
    public com.squareup.okhttp.Call listAsync(String id4n, String organizationId, Boolean includePrivate, Integer offset, Integer limit, final ApiCallback<PaginatedResponseOfHistoryItem> callback) throws ApiException {
    ...
    public HistoryItem retrieveItem(String id4n, String organizationId, Integer sequenceId) throws ApiException {
        ApiResponse<HistoryItem> resp = retrieveItemWithHttpInfo(id4n, organizationId, sequenceId);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call retrieveItemAsync(String id4n, String organizationId, Integer sequenceId, final ApiCallback<HistoryItem> callback) throws ApiException {
