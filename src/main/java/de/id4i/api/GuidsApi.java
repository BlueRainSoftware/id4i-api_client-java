...
public class GuidsApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getGuidCall(String id4n, String organizationId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getGuidValidateBeforeCall(String id4n, String organizationId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getGuidCall(id4n, organizationId, progressListener, progressRequestListener);
        return call;
    ...
    public Guid getGuid(String id4n, String organizationId) throws ApiException {
        ApiResponse<Guid> resp = getGuidWithHttpInfo(id4n, organizationId);
        return resp.getData();
    }
    ...
    public ApiResponse<Guid> getGuidWithHttpInfo(String id4n, String organizationId) throws ApiException {
        com.squareup.okhttp.Call call = getGuidValidateBeforeCall(id4n, organizationId, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getGuidAsync(String id4n, String organizationId, final ApiCallback<Guid> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getGuidValidateBeforeCall(id4n, organizationId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Guid>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getId4nCall(String id4n, String organizationId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getId4nValidateBeforeCall(String id4n, String organizationId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getId4nCall(id4n, organizationId, progressListener, progressRequestListener);
        return call;
    ...
    public Id4nPresentation getId4n(String id4n, String organizationId) throws ApiException {
        ApiResponse<Id4nPresentation> resp = getId4nWithHttpInfo(id4n, organizationId);
        return resp.getData();
    }
    ...
    public ApiResponse<Id4nPresentation> getId4nWithHttpInfo(String id4n, String organizationId) throws ApiException {
        com.squareup.okhttp.Call call = getId4nValidateBeforeCall(id4n, organizationId, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getId4nAsync(String id4n, String organizationId, final ApiCallback<Id4nPresentation> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getId4nValidateBeforeCall(id4n, organizationId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Id4nPresentation>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
