...
import de.id4i.api.model.ImportGS1CodesRequest;
...
public class GuidsApi {
     ...
     * @param createGUIDInfo GUID creation model (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
    ...
    public PaginatedResponseOfGuidCollection getCollections(String id4n, String organizationId, Integer offset, Integer limit) throws ApiException {
        ApiResponse<PaginatedResponseOfGuidCollection> resp = getCollectionsWithHttpInfo(id4n, organizationId, offset, limit);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getCollectionsAsync(String id4n, String organizationId, Integer offset, Integer limit, final ApiCallback<PaginatedResponseOfGuidCollection> callback) throws ApiException {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call importGS1CodesCall(ImportGS1CodesRequest importGS1CodesRequest, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call importGS1CodesValidateBeforeCall(ImportGS1CodesRequest importGS1CodesRequest, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = importGS1CodesCall(importGS1CodesRequest, progressListener, progressRequestListener);
        return call;
    ...
    public ApiResponse<Void> importGS1CodesWithHttpInfo(ImportGS1CodesRequest importGS1CodesRequest) throws ApiException {
        com.squareup.okhttp.Call call = importGS1CodesValidateBeforeCall(importGS1CodesRequest, null, null);
        return apiClient.execute(call);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call importGS1CodesAsync(ImportGS1CodesRequest importGS1CodesRequest, final ApiCallback<Void> callback) throws ApiException {
